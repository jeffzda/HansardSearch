...
def build_newsletter_html(
    ...
    # Extract the narrative h3 title generated by Claude, fall back to phrase display
    _h3_m = re.search(r'<h3>(.*?)</h3>', result.narrative_html or "", re.IGNORECASE)
    narrative_title = _h3_m.group(1) if _h3_m else phrase_display
